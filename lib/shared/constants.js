...
module.exports.RESOURCE_TYPES = {
  POLICIES_BY_CLUSTER: { name: 'HCMPolicyCluster', query: 'ALL_POLICIES' },
  POLICIES_BY_POLICY: { name: 'HCMCompliance', query: 'ALL_POLICIES' },
  POLICY: { name: 'Policy', query: 'Policiesquery' },
  PLACEMENT_RULE: { name: 'PlacementRule', query: 'PlacementRulesquery' },
  PLACEMENT_BINDING: { name: 'PlacementBinding', query: 'PlacementBindingsquery' },
}
