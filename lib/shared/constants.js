...
module.exports.RESOURCE_TYPES = {
  POLICIES_BY_CLUSTER: { name: 'HCMPolicyCluster', list: 'HCMPolicyClusterList' },
  POLICIES_BY_POLICY: { name: 'HCMCompliance', list: 'HCMComplianceList' },
  POLICY: { name: 'Policy', list: 'PoliciesList' },
