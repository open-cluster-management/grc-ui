...
export const PolicyViolationHistory = gql`
query getViolationHistory($policyName: String!, $hubNamespace: String!, $cluster: String!, $template: String!) {
  items: violationHistory(
