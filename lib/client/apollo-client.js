...
class GrcApolloClient {
  ...
  getResource(resourceType, variables = {}) {
    ...
    // console.log(lodash.get(Query, resourceType.name))
  ...
  createAndUpdateResources(resources){
    return client.mutate({ mutation: Query.createAndUpdateResources, variables: { resources } })
  }
