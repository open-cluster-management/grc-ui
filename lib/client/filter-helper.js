...
export const getSavedGrcState = (cookie, directAccess) => {
  let state = {}
...
export const saveGrcState = (cookie, state, directAccess) => {
  if (directAccess) {
    sessionStorage.setItem(cookie, state)
  } else {
...
export const saveGrcStatePair = (cookie, key, value, directAccess) => {
