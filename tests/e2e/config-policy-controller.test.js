...
module.exports = {
  ...
  'Policy controller: single object / musthave + mustnothave': (browser) => {
    ...
    page.checkViolations('policy-pod-single-musthave-inform-' + time, true, 'NonCompliant; violation - pods `nginx-pod-' + time + '` does not exist as specified, and should be create')
    ...
    page.checkViolations('policy-pod-single-mustnothave-inform-' + time, true, 'NonCompliant; violation - pods exist and should be deleted: [nginx-pod-' + time + '] in namespace defaul')
  ...
  'Policy controller: all objects of kind / does not exist': (browser) => {
    ...
    page.checkViolations('policy-pod-musthave-all-' + time, true, 'NonCompliant; violation - No instances of `pods` exist as specified, and one should be create')
