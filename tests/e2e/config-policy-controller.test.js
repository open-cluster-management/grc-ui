...
module.exports = {
  ...
  'Policy controller: single object / musthave + mustnothave': (browser) => {
    ...
    browser.pause(20000)
    page.checkViolations('policy-pod-single-musthave-inform-' + time, true, 'NonCompliant; violation - pods `nginx-pod-' + time + '` does not exist as specified')
    ...
    page.checkViolations('policy-pod-single-mustnothave-inform-' + time, true, 'NonCompliant; violation - pods exist: [nginx-pod-' + time + '] in namespace default')
  ...
  'Policy controller: all objects of kind / does not exist': (browser) => {
    ...
    page.checkViolations('policy-pod-musthave-all-' + time, true, 'NonCompliant; violation - No instances of `pods` exist as specified')
