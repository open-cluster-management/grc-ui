...
module.exports = {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Cluster-wide cluster-admin user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Cluster-wide admin user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Cluster-wide edit user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Cluster-wide view user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Cluster-wide view user in a group': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Namespaced cluster-admin user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Namespaced admin user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Namespaced edit user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Namespaced view user': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Namespaced view user in a group': () => {
  ...
  'GRC: [P1][Sev1][policy-grc] RBAC: Clean up': () => {
    loginPage.authenticate()
