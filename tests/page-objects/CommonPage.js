...
function clickButtonOnOverflowModal(name, nameTarget, overflowPosition, actionName, actionPosition, modalName, clickButtonName){
  ...
  this.waitForElementVisible('.pf-c-dropdown__menu.pf-m-align-right')
  this.waitForElementVisible(`.pf-c-dropdown__menu.pf-m-align-right > li:nth-child(${actionPosition})`)
  this.expect.element(`.pf-c-dropdown__menu.pf-m-align-right > li:nth-child(${actionPosition}) > button`).text.to.equal(actionName)
  this.click(`.pf-c-dropdown__menu.pf-m-align-right > li:nth-child(${actionPosition}) > button`)
