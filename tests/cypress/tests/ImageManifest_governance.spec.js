...
describe('GRC UI: [P1][Sev1][policy-grc] ImageManifest policy governance', () => {
...
describe('RHACM4K-1727 - GRC UI: [P1][Sev1][policy-grc] ImageManifest policy governance - clean up', () => {
