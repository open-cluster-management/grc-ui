  ...
  'policy-crontab-default': {
    ...
    'custom': {
      'metadata.name': {
        ...
        'ref': null,
        'props': {
          'to': '/multicloud/policies/all/policy-crontab',
          'children': 'policy-crontab',
          'replace': false
        },
        '_owner': null,
        '_store': {}
      },
      'metadata.annotations["policy.mcm.ibm.com/standards"]': 'NIST CSF',
      'metadata.annotations["policy.mcm.ibm.com/controls"]': 'PR PT 3 Least Functionality',
      'metadata.annotations["policy.mcm.ibm.com/categories"]': 'PR PT Protective Technology'
    }
  },
  'policy-imagemanifestvulnpolicy-default': {
    'metadata': {
      'name': 'policy-imagemanifestvulnpolicy',
      'namespace': 'default',
      'selfLink': '/apis/policy.mcm.ibm.com/v1alpha1/namespaces/default/policies/policy-imagemanifestvulnpolicy',
    ...
    'custom': {
      'metadata.name': {
        ...
        'ref': null,
        'props': {
          'to': '/multicloud/policies/all/policy-imagemanifestvulnpolicy',
          'children': 'policy-imagemanifestvulnpolicy',
          'replace': false
        },
        '_owner': null,
        '_store': {}
      ...
      'metadata.annotations["policy.mcm.ibm.com/standards"]': 'NIST CSF',
      'metadata.annotations["policy.mcm.ibm.com/controls"]': 'PR AC 4 Access Control, DE CM 8 Vulnerability Scans',
      'metadata.annotations["policy.mcm.ibm.com/categories"]': 'PR AC Identity Management Authentication And Access Control, PR IP Information Protection Processes And Procedures'
    }
  },
  'policy-trustedcontainer-default': {
    'metadata': {
      'name': 'policy-trustedcontainer',
      'namespace': 'default',
      'selfLink': '/apis/policy.mcm.ibm.com/v1alpha1/namespaces/default/policies/policy-trustedcontainer',
    ...
    'custom': {
      'metadata.name': {
        ...
        'ref': null,
        'props': {
          'to': '/multicloud/policies/all/policy-trustedcontainer',
          'children': 'policy-trustedcontainer',
          'replace': false
        },
        '_owner': null,
        '_store': {}
  ...
  'policy2-default': {
    ...
    'custom': {
      'metadata.name': {
        ...
        'ref': null,
        'props': {
          'to': '/multicloud/policies/all/policy2',
          'children': 'policy2',
          'replace': false
        },
        '_owner': null,
      ...
      'metadata.annotations["policy.mcm.ibm.com/standards"]': 'NIST, NIST CSF',
      'metadata.annotations["policy.mcm.ibm.com/controls"]': 'Mutation Advisor, PR PT 3 Least Functionality',
      'metadata.annotations["policy.mcm.ibm.com/categories"]': 'System And Information Integrity, RBAC, PR PT Protective Technology'
    }
  },
  'policy-auth-provider-open-cluster-management-policies': {
    'metadata': {
      'name': 'policy-auth-provider',
      'namespace': 'open-cluster-management-policies',
      'selfLink': '/apis/policy.mcm.ibm.com/v1alpha1/namespaces/open-cluster-management-policies/policies/policy-auth-provider',
    ...
    'custom': {
      'metadata.name': {
        ...
        'ref': null,
        'props': {
          'to': '/multicloud/policies/all/policy-auth-provider',
          'children': 'policy-auth-provider',
          'replace': false
        },
        '_owner': null,
        '_store': {}
      ...
      'metadata.annotations["policy.mcm.ibm.com/standards"]': 'NIST CSF',
      'metadata.annotations["policy.mcm.ibm.com/controls"]': 'PR IP 1 Baseline Configuration',
      'metadata.annotations["policy.mcm.ibm.com/categories"]': 'PR IP Information Protection Processes And Procedures'
    }
  }
}
