...
const GrcRouter = ({ match }) =>
  <Switch>
    ...
    <Route path={`${match.url}/all/:policyNamespace/:policyName/template/:clusterName/:apiGroup/:version/:kind/:name`} render={() => <TemplateDetails secondaryHeaderProps={SECONDARY_HEADER_PROPS} />} />
